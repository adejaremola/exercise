    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Create A New Rate</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('rate.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('multiplier') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="multiplier" type="number" step="0.01" class="form-control" name="multiplier" value="" required>
